...
%    \subsection{Repository}
	...
	Results from \gls{k-means} are displayed on \acrshort{mds} calculated coordinates for the same time period. Training rows for clustering are prepared by encoding votes for given parliament member.
	...
	\begin{figure}%
		\centering
		\subfloat[label 1]{{\includegraphics[width=5cm]{images/kmeans_k2_e1} }}%
		\qquad
		\subfloat[label 2]{{\includegraphics[width=5cm]{images/kmeans_k2_e2} }}%
		\qquad
		\subfloat[label 2]{{\includegraphics[width=5cm]{images/kmeans_k2_e3} }}%
