...
\usepackage{caption} 
\captionsetup[table]{skip=-10pt,position=above,font=small,labelsep=period}
...
{
	name=\textit{k-means},
	description={ \textit{k-means} is a method of vector quantization, that is popular for unsupervised learning. It groups documents into subsets or clusters \cite{ir_book} }
} 
\newglossaryentry{dissimilarity_matrix}
{
	name=dissimilarity matrix,
	description={ It is a matrix which expresses the similarity of pair to pair between two sets \cite{dissimilarity_matrix}}
} 
\newglossaryentry{atviras_seimas}
{
	name=atviras-seimas.lt,
	description={ Domain and name of the project which is being created with the help of research done in this project }
} 
\newglossaryentry{drawio}
{
	name=draw.io,
	description={ Online application for drawing diagrams and prototyping user interfaces. }
} 
\newglossaryentry{http}
{
	name=HTTP,
	description={ Application protocal for distributed hypermedia systems }
} 
\newglossaryentry{euclidian}
{
	name=Euclidian distance,
	description={ It is a straight line in Euclidian space which marks distance between two points. }
} 
\newglossaryentry{jvm}
{
	name=JVM,
	description={ Abstract computing machine which acts like a virtual machine for programs running on it. \cite{jvm} }
} 
\newglossaryentry{javascript}
{
	name=Javascript,
	description={ Programming language written according to ECMAScript specification. One of core technologies of World wide web \cite{js_guide}.}
} 
\newglossaryentry{react}
{
	name=React,
	description={ Javascript library for building user interfaces in a functional manner. }
} 
\newglossaryentry{scalajs}
{
	name=Scala.js,
	description={ Compiler which compiles Scala source code to equivalent Javascript code }
} 
\newglossaryentry{mockup}
{name={Mockup},description={Model of a design which is being built.}}
...
%	\pagenumbering{roman}
	...
	\begin{center}
		\captionof{table}{Term of office table structure}
	...
	\begin{center}
		\captionof{table}{Parliament session table structure}
		\begin{tabular}{L{3cm} L{3cm} L{2.2cm} L{3.8cm}}
			\multicolumn{4}{c}{}\\ 
			\hline
			In XML & In database & Type & Comments\\
			...
			\hline
		\end{tabular} \label{tab:sessions}
	\end{center}
	...
	\begin{center}
		...
		\captionof{table}{Plenary table structure}
		\begin{tabular}{L{3cm} L{3cm} L{2.2cm} L{3.8cm}}
			\multicolumn{4}{c}{}\\ 
			\hline
			In XML & In database & Type & Comments\\
	...
	\begin{center}
		\captionof{table}{Parliament member table structure}
	...
	\begin{center}
		\captionof{table}{Plenary question table structure}
		\begin{tabular}{L{3cm} L{4.2cm} L{3cm} L{2.5cm}}
			\multicolumn{4}{c}{}\\ 
			\hline
			In XML & In database & Type & Comments\\
	...
	\begin{center}
		\captionof{table}{Discussion event table structure}
		\begin{tabular}{L{3cm} L{4.2cm} L{3cm} L{2.5cm}}
			\multicolumn{4}{c}{}\\ 
			\hline
			In XML & In database & Type & Comments\\
	...
	\noindent
	\begin{center}
		\captionof{table}{Functional requirements for \gls{atviras_seimas}} 
	...
	\noindent
	\begin{center}
		\captionof{table}{Statistics of downloaded data}
	...
	\noindent
	\begin{center}
		\captionof{table}{ Encoding of vote outcomes}
	...
	\noindent
	\begin{center}
		\captionof{table}{ Proportion of variance for MDS}
		\begin{tabular}{L{2cm} C{4cm}}
			...
			E3 & 0.764 \\
			\hline
		\end{tabular} \label{tab:mds_performance]}
	\end{center} 
	...
	\begin{center}
			\begin{tabular}{llc}
				...
				Justas        & Džiugelis     & 2
			\end{tabular}
			\captionof{table}{ Members who changed their faction at least one time in current term of office} \label{tab:multi_faction}
	\end{center}
