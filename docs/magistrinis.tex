...
%    \subsection{Repository}
    ...
    \hfill
   	...
   	Since some members joined parliament later or left it before the term of office ended - data is missing on their votes during that time. To counter this - empty training rows are added for that missing time.
